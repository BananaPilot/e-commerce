    ...
    <div className='fixed top-0 z-20 w-full bg-white'>
      <div className='flex p-3 bg-transparent'>
        ...
        </Link>
        {
          ...
          ? (
              <div className='flex absolute right-24'>
                <Link className='text-white bg-violet-700 rounded-xl p-2 hover:bg-violet-500 mx-3' href={routes.signin}>Sign in</Link>
              </div>
            ) : (
                <div className='flex absolute right-24'>
                  <nav>
        ...
        <div className='flex absolute right-2'>
          <Link href={routes.favourites} className='bg-violet-700 rounded-full mx-1 hover:bg-violet-500' ><span className="text-white p-2 material-symbols-outlined">&#xe87d;</span>
          </Link>
          <Link href={routes.cart} className='bg-black rounded-full mx-1 hover:bg-zinc-900'><span className="text-white p-2 material-symbols-outlined">&#xe8cc;</span>
          </Link>
        </div>
      </div>
    </div>  
